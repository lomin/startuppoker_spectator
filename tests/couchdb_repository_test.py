...
import unittest
from startuppoker_spectator.couchdb_repository import get_stake_for_player,\
        get_pot, get_bet_round, get_last_move
...
class LastActionTest(unittest.TestCase):
    ...
    def test_last_action_is_nothing_when_action_is_not_fold_and_before_next_bet_round(self):
        document = {'history': [
